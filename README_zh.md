...
**Football Manager 26 评估工具**

欢迎使用球员和教练组评估工具

## 描述
在过去几年对Football Manager进行了大量测试后，Kinito和DoctorDim帮助我们深入理解了游戏的重要方面。利用他们为社区所做的工作，我创建了这个小工具，帮助你更好地理解球队和俱乐部的管理。

## 功能
- **隐藏属性**: 通过性格、媒体应对、意志力评估球员的隐藏属性
- **教练组**: 评估教练组以最好地满足你的需求。在FM26中，属性用描述性词语显示。
- **报告**: 解读各类报告：球探、教练、个人训练
- **基础设施**: 了解和评估俱乐部的基础设施发展。

## 截图

<p align="center">
  <img src="screenshots/home_zh.png" alt="首页" width="600">
</p>

<p align="center">
  <img src="screenshots/reports_zh.png" alt="报告" width="600">
</p>
